...
module Workers
  module Demo
    module Intelligence
      ##
      # A Sidekiq that persists in Redis desired intelligence data formats.
      ...
      class AddCollectionFormat < Workers::Demo::WorkerWithRedis
        ...
        # Creates a process that updates in Redis desirable intelligence data,
        # to be collected by [FieldAgent].
