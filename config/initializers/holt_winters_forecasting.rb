...
holt_winters_api.set_alpha(0.9, mins_in_an_hour * secs_in_a_min / interval_between_collections)
...
holt_winters_api.set_gamma(0.5, season_duration_in_secs / interval_between_collections)
